...
const myTimetable = {
  Mon: [
    { time: '9:00 AM', subject: 'Data Science', room: 'A101', teacher: 'Dr. Sharma' },
    { time: '10:00 AM', subject: 'Machine Learning', room: 'B202', teacher: 'Dr. Verma' },
    { time: '2:00 PM', subject: 'Python Lab', room: 'Lab 1', teacher: 'Ms. Gupta' },
  ],
  Tue: [
    { time: '9:00 AM', subject: 'Statistics', room: 'A101', teacher: 'Dr. Sharma' },
    { time: '11:00 AM', subject: 'Database', room: 'B202', teacher: 'Mr. Singh' },
  ],
  Wed: [
    { time: '10:00 AM', subject: 'Data Science', room: 'A101', teacher: 'Dr. Sharma' },
    { time: '2:00 PM', subject: 'ML Lab', room: 'Lab 2', teacher: 'Dr. Verma' },
  ],
  Thu: [
    { time: '9:00 AM', subject: 'Database', room: 'A103', teacher: 'Mr. Singh' },
  ],
  Fri: [
    { time: '9:00 AM', subject: 'Python Lab', room: 'Lab 1', teacher: 'Ms. Gupta' },
    { time: '1:00 PM', subject: 'Data Science', room: 'A101', teacher: 'Dr. Sharma' },
  ],
  Sat: [
    { time: '10:00 AM', subject: 'Revision', room: 'A101', teacher: 'Dr. Sharma' },
  ],
};

const myExams = [
  { date: '10', month: 'May', subject: 'Data Science', time: '10:00 AM', room: 'Hall A' },
  { date: '12', month: 'May', subject: 'Machine Learning', time: '10:00 AM', room: 'Hall B' },
  { date: '14', month: 'May', subject: 'AI Fundamentals', time: '2:00 PM', room: 'Hall A' },
  { date: '16', month: 'May', subject: 'Database', time: '10:00 AM', room: 'Hall C' },
];

export default function CollegeStudentScreen({ user, onLogout }) {
